...
import com.example.androidserver.Common.DirectionJSONParser;
import com.example.androidserver.Remote.IGeoCoordinates;
    ...
    private void displayLocation() {
        ...
        else
        {
            ...
            if (mLastLocation !=null)
            {
                ...
                //Add Marker in your location and move to camera
        ...
        mService.getGeoCode(address).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try{
                    ...
                    Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.boxxx);
